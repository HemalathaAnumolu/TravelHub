...
public class Signup extends JFrame implements ActionListener{
	...
	Signup(){
		...
		lblsecurity.setBounds(50,140,100,25);
		p1.add(lblsecurity);
		
		security = new Choice();
		security.add("Select Your Security Question");
		security.add("What is your mother’s maiden name ?");
		security.add("What was the name of your first pet ?");
		security.add("What is the name of your birth place ?");
		...
		lblanswer.setBounds(50,180,100,25);
		p1.add(lblanswer);
